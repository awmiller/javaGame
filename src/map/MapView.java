...
public class MapView extends JPanel {
    ...
    long ping =System.nanoTime();
        ...
        g2d.drawString(String.valueOf(player.addScore(0)),dimens.width/2,dimens.height/2);
    ...
    public Graphics2D drawView(Graphics g, Dimension offset) {
        ...
        g2d.drawString(String.valueOf(player.addScore(0)),dimens.width+offset.width-50,50);
